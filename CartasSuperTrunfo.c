...
int main() {
    ...
    char estado1,estado2;                                   // Armazena a letra do estado
    ...
    unsigned long int populacao1,populacao2;                // População da Cidade (Para Números Grandes)
    ...
    scanf(" %c", &estado1); //%1 Para Aceitar apenas 1 caractere                    
    
    printf("Digite o Código da Carta( Até 3 Caracteres) : \n");
    scanf(" %4s", codigo1); // %4s para aceitar no máximo 3 caracteres
    ...
    scanf(" %lu", &populacao1); // Lê a população da cidade (tipo unsigned long int)
    ...
    // Cálculos da Carta 1
    pibpercapta1 = pib1/ (float)populacao1;   // Calcula o PIB per capita    
    ...
    printf("Digite a letra do estado (A-H):\n");
    scanf(" %c", &estado2); //%1s Para Aceitar apenas 1 caractere                    
    ...
    printf("Digite o Nome da Cidade: \n");
    scanf(" %[^\n]", nome2); // Lê a string com espaços

    printf("Digite a população da cidade:\n");
    scanf(" %lu", &populacao2); // Lê a população da cidade (tipo float)
    ...
    pibpercapta2 = pib2/ (float)populacao2;   // Calcula o PIB per capita    
